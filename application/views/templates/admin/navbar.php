          ...
          <div class="left_col scroll-view" style="background: #fff">
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="<?php echo base_url() ?>assets/production/images/iconklinik.jpg" alt="..." class="img-circle profile_img">
              </div>
              <div class="profile_info">
                <span style="color: #4B6277"><b>SISTEM PAKAR</b></span>
                <h2 style="color: #4B6277">Penyakit Hewan Kelinci</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo site_url() ?>/penyakit" style="color: #2F4356"><i class="fa fa-medkit"></i> Basis Pengetahuan (FC) </a></li>
                  ...
                  <li><a style="color: #2F4356"><i class="fa fa-list"></i> Data Gejala <span class="fa fa-chevron-down" style="color: #2F4356"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="<?php echo site_url() ?>/nilai_cf" style="color: #2F4356">Nilai Certanty Factor</a></li>
                    </ul>
                  </li>
                 <!--  <li><a href="<?php echo site_url() ?>/riwayat" style="color: #2F4356"><i class="fa fa-clipboard"></i> Riwayat Diagnosa </a></li> -->
                  ...
                  <li><a style="color: #2F4356"><i class="fa fa-cogs"></i> Pengaturan <span class="fa fa-chevron-down" style="color: #2F4356"></span></a>
                    <ul class="nav child_menu">
                      <li ><a href="<?php echo site_url() ?>/pengguna" style="color: #2F4356">Data Admin</a></li>
                      <li ><a href="<?php echo base_url() ?>pengguna/pasien" style="color: #2F4356">Data Pasien</a></li>
                      <li ><a href="<?php echo base_url() ?>history" style="color: #2F4356">History Diagnosa</a></li>    
                    </ul>
                  </li>
            ...
            <div class="sidebar-footer hidden-small" style="background: #EDEDED ">
              <?php 
                  if($this->session->userdata('is_login') == TRUE && $this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'pakar'){
              ?>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" style="padding: 12px 28px 12px" data-toggle="dropdown" aria-expanded="false">
                    <img src="<?php echo base_url() ?>assets/production/images/imglagi.jpg" alt=""><?php echo $this->session->userdata('nama')?> - <?php echo $this->session->userdata('level') ?>
