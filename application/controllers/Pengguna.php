...
class Pengguna extends CI_Controller {
	...
	public function pasien(){
		$data['content'] = 'admin/pasien/list'; 
		$data['kelompok_data'] = $this->Pengguna_model->daftarPasien();
		$this->load->view('templates/admin/index', $data);
	}
	...
	public function edit_pasien($id){
		if (isset($_POST['submit'])){
			$this->Pengguna_model->edit_pasien();
			redirect('pengguna/pasien');
		}

		$id=$this->uri->segment(3);
		$data['pengguna'] = $this->Pengguna_model->getByIdPasien($id);
		$data['content'] = 'admin/pasien/edit'; 
		$this->load->view('templates/admin/index', $data);
	}
	...
	public function hapus_pasien(){
		$id=$this->uri->segment(3);
		$this->Pengguna_model->hapus_pasien($id);
		redirect('pengguna/pasien');
	}
